        ...
        <div>
          ...
          <div className="mb-[3rem] flex items-center md:space-x-10">
            ...
            <p className="text-[19px] text-slate-300 w-[80%]">
              web developer with experience working on projects with teams of
              5-10 people. I create responsive, user-friendly applications and
              enjoy collaborating to build high-quality, functional designs.
            </p>
          </div>
          <button
