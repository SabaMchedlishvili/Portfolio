      ...
      <div className="w-[80%] grid-cols-1 mx-auto grid lg:grid-cols-2 gap-[3rem] h-[100%] items-center">
        <div>
          <h1 className="text-[35px] md:text-[50px] text-white font-bold">
            HELLO, I'M <span className="text-yellow-400">SABA !</span>
          </h1>
          <TextEffect />
          <p className="mt-[1.5rem] text-[18px] text-[#ffffff92]">
            passionate web developer with a strong focus on creating visually
            appealing and user-friendly websites. With a deep understanding of
            modern web technologies, I build responsive, high-performance
